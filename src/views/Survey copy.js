        ...
        <div>
            ...
            <div style={{ visibility: Started ? "visible" : "hidden" }}>
                ...
                <div style={{ visibility: showidx[0] ? "visible" : "hidden" }}>
                    <Question addnext={ addnext } addans={addans} q_id={Questionarray[0]} idx={ 0 } id={ Id } />
                </div>
                
                <div style={{ visibility: showidx[1] ? "visible" : "hidden" }}>
                    <Question addnext={ addnext } addans={addans} q_id={Questionarray[1]} idx={ 1 } id={ Id } />
                </div>
                <div style={{ visibility: showidx[2] ? "visible" : "hidden" }}>
                    <Question addnext={ addnext } addans={addans} q_id={Questionarray[2]} idx={ 2 } id={ Id } />
                </div>
                <div style={{ visibility: showidx[3] ? "visible" : "hidden" }}>
                    <Question addnext={ addnext } addans={addans} q_id={Questionarray[3]} idx={ 3 } id={ Id } />
                </div>
                <div style={{ visibility: showidx[4] ? "visible" : "hidden" }}>
                    <Question addnext={ addnext } addans={addans} q_id={Questionarray[4]} idx={ 4 } id={ Id } />
                </div>
                <div style={{ visibility: showidx[5] ? "visible" : "hidden" }}>
                    <Question addnext={ addnext } addans={addans} q_id={Questionarray[5]} idx={ 5 } id={ Id } />
                </div>
                <div style={{ visibility: showidx[6] ? "visible" : "hidden" }}>
                    <Question addnext={ addnext } addans={addans} q_id={Questionarray[6]} idx={ 6 } id={ Id } />
                </div>
                <div style={{ visibility: showidx[7] ? "visible" : "hidden" }}>
                    <Question addnext={ addnext } addans={addans} q_id={Questionarray[7]} idx={ 7 } id={ Id } />
                </div>
                <div style={{ visibility: showidx[8] ? "visible" : "hidden" }}>
                    <Question addnext={ addnext } addans={addans} q_id={Questionarray[8]} idx={ 8 } id={ Id } />
                </div>
                <div style={{ visibility: showidx[9] ? "visible" : "hidden" }}>
                    <Question addnext={ addnext } addans={addans} q_id={Questionarray[9]} idx={ 9 } id={ Id } />
                </div>
                <div style={{ visibility: showidx[10] ? "visible" : "hidden" }}>
                    <Question addnext={ addnext } addans={addans} q_id={Questionarray[10]} idx={ 10 } id={ Id } />
                </div>
                <div style={{ visibility: showidx[11] ? "visible" : "hidden" }}>
                    <Question addnext={ addnext } addans={addans} q_id={Questionarray[11]} idx={ 11 } id={ Id } />
                </div>
                <div style={{ visibility: showidx[12] ? "visible" : "hidden" }}>
                    <Question addnext={ addnext } addans={addans} q_id={Questionarray[12]} idx={ 12 } id={ Id } />
                </div>
                <div style={{ visibility: showidx[13] ? "visible" : "hidden" }}>
                    <Question addnext={ addnext } addans={addans} q_id={Questionarray[13]} idx={ 13 } id={ Id } />
                </div>
                <div style={{ visibility: showidx[14] ? "visible" : "hidden" }}>
                    <Question addnext={ addnext } addans={addans} q_id={Questionarray[14]} idx={ 14 } id={ Id } />
                </div>
                <div style={{ visibility: showidx[15] ? "visible" : "hidden" }}>
                    <Question addnext={ addnext } addans={addans} q_id={Questionarray[15]} idx={ 15 } id={ Id } />
                </div>
                <div style={{ visibility: showidx[16] ? "visible" : "hidden" }}>
                    <Question addnext={ addnext } addans={addans} q_id={Questionarray[16]} idx={ 16 } id={ Id } />
                </div>
                <div style={{ visibility: showidx[17] ? "visible" : "hidden" }}>
                    <Question addnext={ addnext } addans={addans} q_id={Questionarray[17]} idx={ 17 } id={ Id } />
                </div>
                <div style={{ visibility: showidx[18] ? "visible" : "hidden" }}>
                    <Question addnext={ addnext } addans={addans} q_id={Questionarray[18]} idx={ 18 } id={ Id } />
                </div>
                <div style={{ visibility: showidx[19] ? "visible" : "hidden" }}>
                    <Question addnext={ addnext } addans={addans} q_id={Questionarray[19]} idx={ 19 } id={ Id } />
                </div>
